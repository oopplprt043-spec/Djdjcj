...
local AutoFarmingTab, AutoFarmingPage = TabsManager:RegisterTab("เก็บไข่ออโต้69", 4, "เก็บใข่ออโต้69")

--==================================================
-- CONTENT
--==================================================
CreateSectionTitle(AutoFarmingPage, "เก็บใข่ออโต้69", 1)
...
GetEggName.Text = "ไม่ได้เลือกควยไร"
...
local function UpdateGetEggBox(Icon, Name, Rate, EggId)
    ...
    GetEggName.Text = Name or "ไม่ได้เลือกควยไรเลย"
...
CheckEggLabel.Text = "กดตรงนี้เพื่อเริ่มเก็บใข่69"
...
local function CreateEggEntry(EggData)
    ...
    SelectButton.Text = "เลือกใข่ควยนี้"
...
local function RefreshEggList()
    ...
    CheckEggCount.Text = "เกาใข่: " .. #Eggs
end
